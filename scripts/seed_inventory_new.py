import sys, os
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath("C:\\Users\\Curtis\\Desktop\\learningmaterials\\SEMESTER3\\bakery-ai-system\\scripts\\seed_inventory.py"))))
