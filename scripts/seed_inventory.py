...
for b in breads:
    ...
    cur.execute("INSERT INTO batch_inventory (batch_id,product_name,quantity,production_time,tray_color,freshness_status,quantity_initial,quantity_remaining,sales_area) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)",(did,b,5,now,"orange","Day-1",5,5,"Day-1 Area"))
